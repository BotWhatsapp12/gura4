...
runa = process.uptime()         
const gggg = `Aktif Selama ${kyun(runa)}`
...
title : `${ucapanWaktu} - @${sender.split("@")[0]}`,
 buttonText: 'OWNER',
 footerText: '𝐁𝐞𝐫𝐢𝐤𝐮𝐭 𝐀𝐝𝐚𝐥𝐚𝐡 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐆𝐮𝐫𝐚𝐁𝐨𝐭𝐳 :
 ➤ *Other*➤
┃❒き⃟🐣 *.menu*
┃❒き⃟🐣 *.ssweb*
┃❒き⃟🐣 *.runtime*
...
case 'play':
        ...
        py =await gura.prepareMessage(from, ya, image)
        gbutsan = [{buttonId: `${prefix}ytp3 ${yut.all[0].url}`, buttonText: {displayText: '📥AUDIO'}, type: 1},{buttonId: `${prefix}ytp4 ${yut.all[0].url}`, buttonText: {displayText: '📥VIDEO'}, type: 1}]
        gbuttonan = {
        imageMessage: py.message.imageMessage,
        contentText: capti,
        footerText: '```Silahkan Pilih Medianya Kak```',
